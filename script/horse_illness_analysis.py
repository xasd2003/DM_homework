...
fp_train = open("./data/horse-colic.data", 'r')
fp_test = open("./data/horse-colic.test", 'r')
fp_modified = open("./data/data.csv", 'w')
...
# 缺失值个数
data_show['missing'] = data_origin[attribute].describe().loc['count'].apply(lambda x : 368-x)
...
data_filtrated.to_csv('./data/missing_data_delete.csv', mode = 'w', encoding='utf-8', index = False,header = False)
print ('filted_missing_data1 saved at ./image/missing_data_delete.jpg')
print ('data after analysis saved at ./data/missing_data_delete.csv')
...
data_filtrated.to_csv('./data/missing_data_most.csv', mode = 'w', encoding='utf-8', index = False,header = False)
print ('filted_missing_data2 saved at ./image/missing_data_most.jpg')
print ('data after analysis saved at ./data/missing_data_most.csv')
...
data_filtrated.to_csv('./data/missing_data_corelation.csv', mode = 'w', encoding='utf-8', index = False,header = False)
print ('filted_missing_data3 saved at ./image/missing_data_corelation.jpg')
print ('data after analysis saved at ./data/missing_data_corelation.csv')
...
data_filtrated.to_csv('./data/missing_data_similarity.csv', mode = 'w', encoding='utf-8', index = False,header = False)
print ('filted_missing_data4 saved at ./image/filted_missing_data4.jpg')
print ('data after analysis saved at ./data/missing_data_similarity.csv')
